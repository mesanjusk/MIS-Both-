...
export const SIDEBAR_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Ledger', path: ROUTES.LEDGER, icon: <MenuBookRoundedIcon fontSize="small" />, roles: ACCOUNT_ROLES, section: 'money' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Workflow Audit', path: ROUTES.WORKFLOW_AUDIT, icon: <FactCheckRoundedIcon fontSize="small" />, roles: ADMIN_ROLES, section: 'admin' },
